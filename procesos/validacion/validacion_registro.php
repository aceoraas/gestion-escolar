...
//$ajaxNombreUsuario='raas';
//$ajaxContrasenia=$_POST['Contra'];
//$PreguntaSecreta='CUAL ES MI PERRO';
//$RespuestaSecreta='DAVID';
	...
	if($result==true)
 	{
	  ...
	  if($result==true)
	  {
		...
		if($result==true)
		{
		  $data=array('valor'=>'0');$js=json_encode($data);echo $js;
		}else
		{
		  ...
		  if($s>5)
		  {
				...
				}else{$data=array('valor'=>'1');$js=json_encode($data);echo $js;
				 
				  }
			
			
		  }else{$data=array('valor'=>'0');$js=json_encode($data);echo $js;}
		}
	   }else{$data=array('valor'=>'0');$js=json_encode($data);echo $js;}
	}else{$data=array('valor'=>'0');$js=json_encode($data);echo $js;}
   }
